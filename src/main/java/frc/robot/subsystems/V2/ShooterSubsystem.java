...
public class ShooterSubsystem {
    ...
    // private Supplier<AngularVelocity> flywheelVelocitySupplier = () ->
    ...
    public ShooterSubsystem(Supplier<Pose2d> poseSupplier) {
        ...
        // turret.setAngle((Supplier<Angle>) () ->
        // Degrees.of(computeHubAngle(poseSupplier))));
    }
    ...
    // public void setVelocityCommand(LinearVelocity velocity){
    // flywheel.setRPMCommand(velocity);
    // }
